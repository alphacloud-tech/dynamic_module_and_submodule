!(function () {
  ...
  function y(e) {
    "vertical" == e
      ? ((document.getElementById("two-column-menu").innerHTML = ""), document.querySelector(".navbar-menu") && (document.querySelector(".navbar-menu").innerHTML = d), document.getElementById("theme-settings-offcanvas") && ((document.getElementById("sidebar-size").style.display = "block"), (document.getElementById("sidebar-view").style.display = "block"), (document.getElementById("sidebar-color").style.display = "block"), document.getElementById("sidebar-img") && (document.getElementById("sidebar-img").style.display = "block"), (document.getElementById("layout-position").style.display = "block"), (document.getElementById("layout-width").style.display = "block"), (document.getElementById("sidebar-visibility").style.display = "none")), r(), g(), E(), p())
      : "horizontal" == e
  ...
  sessionStorage.getItem("defaultAttribute")
    ? (((f = {})["data-layout"] = sessionStorage.getItem("data-layout")), (f["data-sidebar-size"] = sessionStorage.getItem("data-sidebar-size")), (f["data-bs-theme"] = sessionStorage.getItem("data-bs-theme")), (f["data-layout-width"] = sessionStorage.getItem("data-layout-width")), (f["data-sidebar"] = sessionStorage.getItem("data-sidebar")), (f["data-sidebar-image"] = sessionStorage.getItem("data-sidebar-image")), (f["data-layout-position"] = sessionStorage.getItem("data-layout-position")), (f["data-layout-style"] = sessionStorage.getItem("data-layout-style")), (f["data-topbar"] = sessionStorage.getItem("data-topbar")), (f["data-preloader"] = sessionStorage.getItem("data-preloader")), (f["data-body-image"] = sessionStorage.getItem("data-body-image")), e(f))
