...
<!-- Mirrored from themesbrand.com/velzon/html/material/auth-signup-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 May 2024 12:08:41 GMT -->
                            ...
                            <div class="row justify-content-center g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="mt-4 registration-form-container">
                                            <form method="POST" action="{{ route('register') }}">
                                                @csrf

                                                <div class="mb-3">
                                                    <label for="name" class="form-label">Fullname <span
                                                            class="text-danger">*</span></label>
                                                    <input class="form-control" id="name"
                                                        placeholder="Enter email fullname" type="text" name="name"
                                                ...
                                                {{-- <div class="mb-3">
                                                    ...
                                                    <select name='userrole' class="form-control" id="userrole">
                                                        ...
                                                        @foreach ($roles as $list)
                                                            <option value="{{ $list->id }}">{{ $list->rolename }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    <div class="invalid-feedback">
